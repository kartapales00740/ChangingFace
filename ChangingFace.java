...
public class ChangingFace extends Application {
    ...
    public void start(Stage stage) {
        ...
        mouth.setLength(-180);
        caption.setText("Smiling Face");
        });
        // supply the code that is executed when the frown button is pressed
        frownButton.setOnAction(e -> {
        mouth.setLength(180);
        caption.setText("Frowning Face");
        });
        semiFrownButton.setOnAction(e -> {
        mouth.setLength(120);
        caption.setText("Semi-frowning Face");
        });
